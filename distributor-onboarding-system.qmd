...
description: 'A structured plan for implementing a distributor onboarding system using a C# backend, Apache MiNiFi, and NiFi to automate ERP system integrations.'
format:
  html:
    toc: true
    toc-depth: 2
